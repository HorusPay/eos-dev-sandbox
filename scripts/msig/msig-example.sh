...
# bash ${HORUS_SCRIPT_HOME}/account.sh mymultisig11 ${OWNER_PUBLIC_KEY}
# bash ${HORUS_SCRIPT_HOME}/account.sh partner11111 ${OWNER_PUBLIC_KEY}
# bash ${HORUS_SCRIPT_HOME}/account.sh partner22222 ${OWNER_PUBLIC_KEY}
# bash ${HORUS_SCRIPT_HOME}/account.sh partner33333 ${OWNER_PUBLIC_KEY}
...
cleos multisig propose payme '[{"actor": "partner22222", "permission": "active"},{"actor": "partner33333", "permission": "active"}]' '[{"actor": "mymultisig11", "permission": "active"}]' HORUS.token transfer '{"from":"mymultisig11", "to":"partner11111", "quantity":"25.0000 SYS", "memo":"Pay partner11111 some money"}' partner11111 -p partner11111@active 
